-- Generated from Simulink block receive1_3_16b/0001_
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_0001 is
  port (
...
end receive1_3_16b_0001;
architecture structural of receive1_3_16b_0001 is 
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  constant17 : entity xil_defaultlib.sysgen_constant_aff9853abc 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  counter : entity xil_defaultlib.receive1_3_16b_xlcounter_free 
  generic map (
    core_name0 => "receive1_3_16b_c_counter_binary_v12_0_i0",
    op_arith => xlUnsigned,
    op_width => 2
  )
  port map (
  ...
  register_x0 : entity xil_defaultlib.receive1_3_16b_xlregister 
  generic map (
    d_width => 1,
    init_value => b"0"
  )
  ...
  relational : entity xil_defaultlib.sysgen_relational_1d0db16bb8 
  port map (
    clr => '0',
    a => counter_op_net,
    b => constant17_op_net,
  ...
  const : entity xil_defaultlib.sysgen_constant_eca4ad436d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block receive1_3_16b/Subsystem/vector_acc
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_acc is
  port (
...
end receive1_3_16b_vector_acc;
architecture structural of receive1_3_16b_vector_acc is 
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  addsub1 : entity xil_defaultlib.receive1_3_16b_xladdsub 
  generic map (
    a_arith => xlSigned,
    a_bin_pt => 14,
    a_width => 16,
    ...
    c_latency => 1,
    c_output_width => 33,
    core_name0 => "receive1_3_16b_c_addsub_v12_0_i0",
    extra_registers => 1,
    full_s_arith => 2,
    full_s_width => 33,
    latency => 2,
  ...
  constant1 : entity xil_defaultlib.sysgen_constant_349a6ae4e5 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant10 : entity xil_defaultlib.sysgen_constant_d40f3b2e0a 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant2 : entity xil_defaultlib.sysgen_constant_eca4ad436d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant4 : entity xil_defaultlib.sysgen_constant_eca4ad436d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant5 : entity xil_defaultlib.sysgen_constant_5092dabef7 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant7 : entity xil_defaultlib.sysgen_constant_eca4ad436d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant9 : entity xil_defaultlib.sysgen_constant_eca4ad436d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  counter2 : entity xil_defaultlib.receive1_3_16b_xlcounter_free 
  generic map (
    core_name0 => "receive1_3_16b_c_counter_binary_v12_0_i1",
    op_arith => xlUnsigned,
    op_width => 24
  )
  port map (
  ...
  counter3 : entity xil_defaultlib.receive1_3_16b_xlcounter_free 
  generic map (
    core_name0 => "receive1_3_16b_c_counter_binary_v12_0_i2",
    op_arith => xlUnsigned,
    op_width => 9
  )
  port map (
  ...
  delay1 : entity xil_defaultlib.receive1_3_16b_xldelay 
  generic map (
    latency => 513,
    reg_retiming => 0,
    reset => 0,
  ...
  delay18 : entity xil_defaultlib.receive1_3_16b_xldelay 
  generic map (
    latency => 508,
    reg_retiming => 0,
    reset => 0,
  ...
  delay19 : entity xil_defaultlib.receive1_3_16b_xldelay 
  generic map (
    latency => 2,
    reg_retiming => 0,
    reset => 0,
  ...
  delay2 : entity xil_defaultlib.receive1_3_16b_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  delay21 : entity xil_defaultlib.receive1_3_16b_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  delay3 : entity xil_defaultlib.receive1_3_16b_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  delay4 : entity xil_defaultlib.receive1_3_16b_xldelay 
  generic map (
    latency => 2,
    reg_retiming => 0,
    reset => 0,
  ...
  fifo1 : entity xil_defaultlib.receive1_3_16b_xlfifogen_u 
  generic map (
    core_name0 => "receive1_3_16b_fifo_generator_i0",
    data_count_width => 10,
    data_width => 32,
    extra_registers => 1,
    has_ae => 0,
  ...
  logical : entity xil_defaultlib.sysgen_logical_4a93b85109 
  port map (
    clr => '0',
  ...
  logical1 : entity xil_defaultlib.sysgen_logical_3b61b47861 
  port map (
    clr => '0',
    d0 => delay3_q_net,
    d1 => mux3_y_net,
  ...
  mux1 : entity xil_defaultlib.sysgen_mux_347370d2db 
  port map (
    clr => '0',
  ...
  mux2 : entity xil_defaultlib.sysgen_mux_d39bed5704 
  port map (
    clr => '0',
    sel => mux3_y_net,
    d0 => fifo1_dout_net,
  ...
  mux3 : entity xil_defaultlib.sysgen_mux_e72726a790 
  port map (
    clr => '0',
    sel(0) => cordic_6_0_0_m_axis_dout_tvalid_net,
    d0 => constant2_op_net,
  ...
  register1 : entity xil_defaultlib.receive1_3_16b_xlregister 
  generic map (
    d_width => 1,
    init_value => b"0"
  )
  ...
  relational1 : entity xil_defaultlib.sysgen_relational_353e7de422 
  port map (
    clr => '0',
    a => counter2_op_net,
    b => delay16_q_net,
  ...
  relational2 : entity xil_defaultlib.sysgen_relational_81f1cb657f 
  port map (
    clr => '0',
    a => counter3_op_net,
    b => constant10_op_net,
...
-- Generated from Simulink block receive1_3_16b/Subsystem/vector_acc1
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_acc1 is
  port (
    data_in : in std_logic_vector( 16-1 downto 0 );
    rst : in std_logic_vector( 1-1 downto 0 );
    tvalid_in : in std_logic;
...
end receive1_3_16b_vector_acc1;
architecture structural of receive1_3_16b_vector_acc1 is 
  signal delay16_q_net : std_logic_vector( 23-1 downto 0 );
  signal delay2_q_net : std_logic_vector( 32-1 downto 0 );
  signal logical_y_net_x0 : std_logic_vector( 1-1 downto 0 );
  signal ce_net : std_logic;
...
-- Generated from Simulink block receive1_3_16b/Subsystem/vector_acc2
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_acc2 is
  port (
    data_in : in std_logic_vector( 16-1 downto 0 );
    rst : in std_logic_vector( 1-1 downto 0 );
    tvalid_in : in std_logic;
...
end receive1_3_16b_vector_acc2;
architecture structural of receive1_3_16b_vector_acc2 is 
  signal mux1_y_net : std_logic_vector( 16-1 downto 0 );
  signal addsub1_s_net : std_logic_vector( 32-1 downto 0 );
...
-- Generated from Simulink block receive1_3_16b/Subsystem/vector_acc3
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_acc3 is
  port (
    data_in : in std_logic_vector( 16-1 downto 0 );
    rst : in std_logic_vector( 1-1 downto 0 );
    tvalid_in : in std_logic;
...
end receive1_3_16b_vector_acc3;
architecture structural of receive1_3_16b_vector_acc3 is 
  signal constant2_op_net : std_logic_vector( 1-1 downto 0 );
  signal mux1_y_net : std_logic_vector( 16-1 downto 0 );
  signal constant4_op_net : std_logic_vector( 1-1 downto 0 );
  signal cordic_6_0_0_m_axis_dout_tvalid_net : std_logic;
...
-- Generated from Simulink block receive1_3_16b/Subsystem/vector_acc4
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_acc4 is
  port (
    data_in : in std_logic_vector( 16-1 downto 0 );
    rst : in std_logic_vector( 1-1 downto 0 );
    tvalid_in : in std_logic;
...
end receive1_3_16b_vector_acc4;
architecture structural of receive1_3_16b_vector_acc4 is 
  signal delay2_q_net : std_logic_vector( 32-1 downto 0 );
  signal logical_y_net_x0 : std_logic_vector( 1-1 downto 0 );
  signal cordic_6_0_0_m_axis_dout_tvalid_net : std_logic;
  signal delay16_q_net : std_logic_vector( 23-1 downto 0 );
...
-- Generated from Simulink block receive1_3_16b/Subsystem/vector_acc5
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_acc5 is
  port (
    data_in : in std_logic_vector( 16-1 downto 0 );
    rst : in std_logic_vector( 1-1 downto 0 );
    tvalid_in : in std_logic;
...
end receive1_3_16b_vector_acc5;
architecture structural of receive1_3_16b_vector_acc5 is 
  signal mux1_y_net : std_logic_vector( 16-1 downto 0 );
  signal delay2_q_net : std_logic_vector( 32-1 downto 0 );
  signal logical_y_net_x0 : std_logic_vector( 1-1 downto 0 );
  signal clk_net : std_logic;
...
-- Generated from Simulink block receive1_3_16b/Subsystem/vector_acc6
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_acc6 is
  port (
    data_in : in std_logic_vector( 16-1 downto 0 );
    rst : in std_logic_vector( 1-1 downto 0 );
    tvalid_in : in std_logic;
...
end receive1_3_16b_vector_acc6;
architecture structural of receive1_3_16b_vector_acc6 is 
  signal fifo1_empty_net : std_logic;
  signal fifo1_full_net : std_logic;
  signal relational1_op_net : std_logic_vector( 1-1 downto 0 );
  signal constant7_op_net : std_logic_vector( 1-1 downto 0 );
...
-- Generated from Simulink block receive1_3_16b/Subsystem/vector_acc7
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_acc7 is
  port (
    data_in : in std_logic_vector( 16-1 downto 0 );
    rst : in std_logic_vector( 1-1 downto 0 );
    tvalid_in : in std_logic;
...
end receive1_3_16b_vector_acc7;
architecture structural of receive1_3_16b_vector_acc7 is 
...
-- Generated from Simulink block receive1_3_16b/Subsystem
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_subsystem is
  port (
    rst : in std_logic_vector( 1-1 downto 0 );
    tvalid_in : in std_logic;
    acc_length : in std_logic_vector( 23-1 downto 0 );
...
end receive1_3_16b_subsystem;
architecture structural of receive1_3_16b_subsystem is 
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  vector_acc : entity xil_defaultlib.receive1_3_16b_vector_acc 
  port map (
  ...
  vector_acc1 : entity xil_defaultlib.receive1_3_16b_vector_acc1 
  port map (
  ...
  vector_acc2 : entity xil_defaultlib.receive1_3_16b_vector_acc2 
  port map (
  ...
  vector_acc3 : entity xil_defaultlib.receive1_3_16b_vector_acc3 
  port map (
  ...
  vector_acc4 : entity xil_defaultlib.receive1_3_16b_vector_acc4 
  port map (
  ...
  vector_acc5 : entity xil_defaultlib.receive1_3_16b_vector_acc5 
  port map (
  ...
  vector_acc6 : entity xil_defaultlib.receive1_3_16b_vector_acc6 
  port map (
  ...
  vector_acc7 : entity xil_defaultlib.receive1_3_16b_vector_acc7 
  port map (
...
-- Generated from Simulink block receive1_3_16b/Vector Concat
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_concat is
  port (
...
end receive1_3_16b_vector_concat;
architecture structural of receive1_3_16b_vector_concat is 
...
begin
  ...
  concat0 : entity xil_defaultlib.sysgen_concat_50ee5f6fb4 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat1 : entity xil_defaultlib.sysgen_concat_50ee5f6fb4 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat2 : entity xil_defaultlib.sysgen_concat_50ee5f6fb4 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat3 : entity xil_defaultlib.sysgen_concat_50ee5f6fb4 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block receive1_3_16b/Vector Constant
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_constant is
  port (
...
end receive1_3_16b_vector_constant;
architecture structural of receive1_3_16b_vector_constant is 
...
begin
  ...
  constant0 : entity xil_defaultlib.sysgen_constant_5a23b0aad5 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant1 : entity xil_defaultlib.sysgen_constant_5a23b0aad5 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant2 : entity xil_defaultlib.sysgen_constant_5a23b0aad5 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant3 : entity xil_defaultlib.sysgen_constant_5a23b0aad5 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block receive1_3_16b/Vector Delay
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_delay is
  port (
...
end receive1_3_16b_vector_delay;
architecture structural of receive1_3_16b_vector_delay is 
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  delay0 : entity xil_defaultlib.receive1_3_16b_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
...
-- Generated from Simulink block receive1_3_16b/Vector Delay1
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_delay1 is
  port (
    d_1 : in std_logic_vector( 16-1 downto 0 );
    d_2 : in std_logic_vector( 16-1 downto 0 );
    d_3 : in std_logic_vector( 16-1 downto 0 );
...
end receive1_3_16b_vector_delay1;
architecture structural of receive1_3_16b_vector_delay1 is 
...
-- Generated from Simulink block receive1_3_16b/Vector FFT
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_fft is
  port (
    i_re_1 : in std_logic_vector( 13-1 downto 0 );
    i_im_1 : in std_logic_vector( 13-1 downto 0 );
    vi : in std_logic_vector( 1-1 downto 0 );
    si : in std_logic_vector( 11-1 downto 0 );
    i_re_2 : in std_logic_vector( 13-1 downto 0 );
    i_re_3 : in std_logic_vector( 13-1 downto 0 );
    i_re_4 : in std_logic_vector( 13-1 downto 0 );
    i_im_2 : in std_logic_vector( 13-1 downto 0 );
    i_im_3 : in std_logic_vector( 13-1 downto 0 );
    i_im_4 : in std_logic_vector( 13-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    o_re_1 : out std_logic_vector( 16-1 downto 0 );
    o_im_1 : out std_logic_vector( 16-1 downto 0 );
    vo : out std_logic;
    so : out std_logic_vector( 11-1 downto 0 );
...
end receive1_3_16b_vector_fft;
architecture structural of receive1_3_16b_vector_fft is 
  ...
  signal slice1_y_net_x1 : std_logic_vector( 13-1 downto 0 );
  signal slice3_y_net_x1 : std_logic_vector( 13-1 downto 0 );
  signal delay1_q_net_x0 : std_logic_vector( 1-1 downto 0 );
  signal reinterpret14_output_port_net : std_logic_vector( 16-1 downto 0 );
  signal slice0_y_net_x0 : std_logic_vector( 13-1 downto 0 );
  signal slice3_y_net_x0 : std_logic_vector( 13-1 downto 0 );
  signal clk_net : std_logic;
  signal slice1_y_net_x0 : std_logic_vector( 13-1 downto 0 );
  signal slice0_y_net_x1 : std_logic_vector( 13-1 downto 0 );
  signal concat2_y_net : std_logic_vector( 26-1 downto 0 );
  signal concat0_y_net : std_logic_vector( 26-1 downto 0 );
  signal reinterpret4_output_port_net : std_logic_vector( 13-1 downto 0 );
  signal concat1_y_net : std_logic_vector( 26-1 downto 0 );
  signal reinterpret2_output_port_net : std_logic_vector( 13-1 downto 0 );
  signal delay2_q_net_x0 : std_logic_vector( 11-1 downto 0 );
  signal slice2_y_net_x1 : std_logic_vector( 13-1 downto 0 );
  signal reinterpret0_output_port_net : std_logic_vector( 13-1 downto 0 );
  signal reinterpret6_output_port_net : std_logic_vector( 13-1 downto 0 );
  signal slice2_y_net_x0 : std_logic_vector( 13-1 downto 0 );
  signal ce_net : std_logic;
  signal concat3_y_net : std_logic_vector( 26-1 downto 0 );
  ...
  signal concat4_y_net : std_logic_vector( 104-1 downto 0 );
  ...
  signal test_systolicfft_vhdl_black_box_o_net : std_logic_vector( 128-1 downto 0 );
begin
  ...
  slice0_y_net_x0 <= i_re_1;
  slice0_y_net_x1 <= i_im_1;
  delay1_q_net_x0 <= vi;
  delay2_q_net_x0 <= si;
  slice1_y_net_x0 <= i_re_2;
  slice2_y_net_x0 <= i_re_3;
  slice3_y_net_x0 <= i_re_4;
  slice1_y_net_x1 <= i_im_2;
  slice2_y_net_x1 <= i_im_3;
  slice3_y_net_x1 <= i_im_4;
  clk_net <= clk_1;
  ce_net <= ce_1;
  concat0 : entity xil_defaultlib.sysgen_concat_1d88dbc223 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat1 : entity xil_defaultlib.sysgen_concat_1d88dbc223 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat2 : entity xil_defaultlib.sysgen_concat_1d88dbc223 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat3 : entity xil_defaultlib.sysgen_concat_1d88dbc223 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat4 : entity xil_defaultlib.sysgen_concat_14a92f7968 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  delay : entity xil_defaultlib.receive1_3_16b_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  delay5 : entity xil_defaultlib.receive1_3_16b_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  reinterpret0 : entity xil_defaultlib.sysgen_reinterpret_a56e24ee36 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
    input_port => slice0_y_net_x1,
    output_port => reinterpret0_output_port_net
  );
  reinterpret1 : entity xil_defaultlib.sysgen_reinterpret_a56e24ee36 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret10 : entity xil_defaultlib.sysgen_reinterpret_b83bc3e312 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret11 : entity xil_defaultlib.sysgen_reinterpret_b83bc3e312 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret12 : entity xil_defaultlib.sysgen_reinterpret_b83bc3e312 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret13 : entity xil_defaultlib.sysgen_reinterpret_b83bc3e312 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret14 : entity xil_defaultlib.sysgen_reinterpret_b83bc3e312 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret15 : entity xil_defaultlib.sysgen_reinterpret_b83bc3e312 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret2 : entity xil_defaultlib.sysgen_reinterpret_a56e24ee36 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
    input_port => slice2_y_net_x1,
    output_port => reinterpret2_output_port_net
  );
  reinterpret3 : entity xil_defaultlib.sysgen_reinterpret_a56e24ee36 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
    input_port => slice3_y_net_x1,
    output_port => reinterpret3_output_port_net
  );
  reinterpret4 : entity xil_defaultlib.sysgen_reinterpret_a56e24ee36 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
    input_port => slice0_y_net_x0,
    output_port => reinterpret4_output_port_net
  );
  reinterpret5 : entity xil_defaultlib.sysgen_reinterpret_a56e24ee36 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret6 : entity xil_defaultlib.sysgen_reinterpret_a56e24ee36 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret7 : entity xil_defaultlib.sysgen_reinterpret_a56e24ee36 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret8 : entity xil_defaultlib.sysgen_reinterpret_b83bc3e312 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret9 : entity xil_defaultlib.sysgen_reinterpret_b83bc3e312 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  slice0 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 31,
    x_width => 128,
  ...
  slice1 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 32,
    new_msb => 63,
    x_width => 128,
  ...
  slice10 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 16,
    new_msb => 31,
    x_width => 32,
  ...
  slice11 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 16,
    new_msb => 31,
    x_width => 32,
  ...
  slice2 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 64,
    new_msb => 95,
    x_width => 128,
  ...
  slice3 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 96,
    new_msb => 127,
    x_width => 128,
  ...
  slice4 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 15,
    x_width => 32,
  ...
  slice5 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 15,
    x_width => 32,
  ...
  slice6 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 15,
    x_width => 32,
  ...
  slice7 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 15,
    x_width => 32,
  ...
  slice8 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 16,
    new_msb => 31,
    x_width => 32,
  ...
  slice9 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 16,
    new_msb => 31,
    x_width => 32,
  ...
  test_systolicfft_vhdl_black_box : entity xil_defaultlib.WRAPPER_VECTOR_FFT_047d8b544995f143c06c9182f67937f6 
  generic map (
    BRAM_THRESHOLD => 258,
    DSP48E => 2,
    I_high => 12,
...
-- Generated from Simulink block receive1_3_16b/Vector Mux
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_mux is
  port (
    sel : in std_logic_vector( 1-1 downto 0 );
    i0_1 : in std_logic_vector( 16-1 downto 0 );
    i1_1 : in std_logic_vector( 16-1 downto 0 );
    i0_2 : in std_logic_vector( 16-1 downto 0 );
    i0_3 : in std_logic_vector( 16-1 downto 0 );
    i0_4 : in std_logic_vector( 16-1 downto 0 );
    i1_2 : in std_logic_vector( 16-1 downto 0 );
    i1_3 : in std_logic_vector( 16-1 downto 0 );
    i1_4 : in std_logic_vector( 16-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end receive1_3_16b_vector_mux;
architecture structural of receive1_3_16b_vector_mux is 
  signal constant0_op_net : std_logic_vector( 16-1 downto 0 );
  signal reinterpret8_output_port_net : std_logic_vector( 16-1 downto 0 );
  signal constant1_op_net : std_logic_vector( 16-1 downto 0 );
  signal register_q_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  mux0 : entity xil_defaultlib.sysgen_mux_347370d2db 
  port map (
    clr => '0',
    sel => register_q_net,
    d0 => constant0_op_net,
  ...
  mux2 : entity xil_defaultlib.sysgen_mux_347370d2db 
  port map (
    clr => '0',
    sel => register_q_net,
    d0 => constant2_op_net,
  ...
  mux3 : entity xil_defaultlib.sysgen_mux_347370d2db 
  port map (
    clr => '0',
    sel => register_q_net,
    d0 => constant3_op_net,
...
-- Generated from Simulink block receive1_3_16b/Vector Mux1
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_mux1 is
  port (
    sel : in std_logic_vector( 1-1 downto 0 );
    i0_1 : in std_logic_vector( 16-1 downto 0 );
    i1_1 : in std_logic_vector( 16-1 downto 0 );
...
end receive1_3_16b_vector_mux1;
architecture structural of receive1_3_16b_vector_mux1 is 
  signal mux1_y_net : std_logic_vector( 16-1 downto 0 );
  signal mux0_y_net : std_logic_vector( 16-1 downto 0 );
  signal register_q_net : std_logic_vector( 1-1 downto 0 );
  signal mux3_y_net : std_logic_vector( 16-1 downto 0 );
...
-- Generated from Simulink block receive1_3_16b/Vector Reinterpret
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_reinterpret is
  port (
...
end receive1_3_16b_vector_reinterpret;
architecture structural of receive1_3_16b_vector_reinterpret is 
  signal reinterpret1_output_port_net : std_logic_vector( 16-1 downto 0 );
  signal reinterpret3_output_port_net : std_logic_vector( 16-1 downto 0 );
  signal mux1_y_net : std_logic_vector( 16-1 downto 0 );
  signal mux3_y_net : std_logic_vector( 16-1 downto 0 );
...
begin
  ...
  mux2_y_net <= in_3;
  mux3_y_net <= in_4;
  reinterpret0 : entity xil_defaultlib.sysgen_reinterpret_0c631e7bf5 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret1 : entity xil_defaultlib.sysgen_reinterpret_0c631e7bf5 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret2 : entity xil_defaultlib.sysgen_reinterpret_0c631e7bf5 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret3 : entity xil_defaultlib.sysgen_reinterpret_0c631e7bf5 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block receive1_3_16b/Vector Reinterpret2
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_reinterpret2 is
  port (
    in_1 : in std_logic_vector( 16-1 downto 0 );
    in_2 : in std_logic_vector( 16-1 downto 0 );
    in_3 : in std_logic_vector( 16-1 downto 0 );
...
end receive1_3_16b_vector_reinterpret2;
architecture structural of receive1_3_16b_vector_reinterpret2 is 
  signal reinterpret2_output_port_net : std_logic_vector( 16-1 downto 0 );
  signal mux3_y_net : std_logic_vector( 16-1 downto 0 );
  signal reinterpret3_output_port_net : std_logic_vector( 16-1 downto 0 );
  signal reinterpret1_output_port_net : std_logic_vector( 16-1 downto 0 );
...
-- Generated from Simulink block receive1_3_16b/Vector Slice
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_slice is
  port (
    in_1 : in std_logic_vector( 16-1 downto 0 );
    in_2 : in std_logic_vector( 16-1 downto 0 );
    in_3 : in std_logic_vector( 16-1 downto 0 );
    in_4 : in std_logic_vector( 16-1 downto 0 );
    out_1 : out std_logic_vector( 13-1 downto 0 );
    out_2 : out std_logic_vector( 13-1 downto 0 );
    out_3 : out std_logic_vector( 13-1 downto 0 );
    out_4 : out std_logic_vector( 13-1 downto 0 )
  );
end receive1_3_16b_vector_slice;
architecture structural of receive1_3_16b_vector_slice is 
  signal delay2_q_net : std_logic_vector( 16-1 downto 0 );
  signal delay3_q_net : std_logic_vector( 16-1 downto 0 );
  signal slice2_y_net : std_logic_vector( 13-1 downto 0 );
  signal slice0_y_net : std_logic_vector( 13-1 downto 0 );
...
-- Generated from Simulink block receive1_3_16b/Vector Slice1
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_slice1 is
  port (
    in_1 : in std_logic_vector( 16-1 downto 0 );
    in_2 : in std_logic_vector( 16-1 downto 0 );
    in_3 : in std_logic_vector( 16-1 downto 0 );
...
end receive1_3_16b_vector_slice1;
architecture structural of receive1_3_16b_vector_slice1 is 
  signal slice1_y_net : std_logic_vector( 13-1 downto 0 );
  signal delay2_q_net : std_logic_vector( 16-1 downto 0 );
  signal slice3_y_net : std_logic_vector( 13-1 downto 0 );
  signal slice0_y_net : std_logic_vector( 13-1 downto 0 );
...
-- Generated from Simulink block receive1_3_16b/Vector to Scalar
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_vector_to_scalar is
  port (
...
end receive1_3_16b_vector_to_scalar;
architecture structural of receive1_3_16b_vector_to_scalar is 
  signal concat2_y_net : std_logic_vector( 32-1 downto 0 );
  signal concat0_y_net : std_logic_vector( 32-1 downto 0 );
  signal concat3_y_net : std_logic_vector( 32-1 downto 0 );
...
begin
  ...
  concat2_y_net <= i_3;
  concat3_y_net <= i_4;
  concat1 : entity xil_defaultlib.sysgen_concat_5c52ce5aa5 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block receive1_3_16b/beat_dphi0/rst_det
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_rst_det_x0 is
  port (
...
end receive1_3_16b_rst_det_x0;
architecture structural of receive1_3_16b_rst_det_x0 is 
  signal delay4_q_net : std_logic_vector( 1-1 downto 0 );
  signal ce_net : std_logic;
  signal clk_net : std_logic;
  signal logical_y_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  inverter : entity xil_defaultlib.sysgen_inverter_fa5d2f3a2b 
  port map (
    clr => '0',
    ip => delay4_q_net,
    clk => clk_net,
  ...
  logical : entity xil_defaultlib.sysgen_logical_3b61b47861 
  port map (
    clr => '0',
    d0 => logical1_y_net,
    d1 => register_q_net,
  ...
  logical1 : entity xil_defaultlib.sysgen_logical_87f78fab8f 
  port map (
    clr => '0',
    d0 => inverter_op_net,
    d1 => register_q_net,
...
-- Generated from Simulink block receive1_3_16b/beat_dphi0
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_beat_dphi0 is
  port (
...
end receive1_3_16b_beat_dphi0;
architecture structural of receive1_3_16b_beat_dphi0 is 
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  rst_det : entity xil_defaultlib.receive1_3_16b_rst_det_x0 
  port map (
    in_x0 => delay4_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  addsub : entity xil_defaultlib.receive1_3_16b_xladdsub 
  generic map (
    a_arith => xlUnsigned,
    a_bin_pt => 0,
    a_width => 16,
    ...
    c_latency => 1,
    c_output_width => 17,
    core_name0 => "receive1_3_16b_c_addsub_v12_0_i1",
    extra_registers => 1,
    full_s_arith => 1,
    full_s_width => 17,
    latency => 2,
  ...
  constant3 : entity xil_defaultlib.sysgen_constant_47b1ca8820 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant5 : entity xil_defaultlib.sysgen_constant_349a6ae4e5 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant6 : entity xil_defaultlib.sysgen_constant_eca4ad436d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant8 : entity xil_defaultlib.sysgen_constant_349a6ae4e5 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  convert2 : entity xil_defaultlib.receive1_3_16b_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 2,
    din_bin_pt => 15,
  ...
  delay16 : entity xil_defaultlib.receive1_3_16b_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  delay17 : entity xil_defaultlib.receive1_3_16b_xldelay 
  generic map (
    latency => 508,
    reg_retiming => 0,
    reset => 0,
  ...
  delay37 : entity xil_defaultlib.receive1_3_16b_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  delay38 : entity xil_defaultlib.receive1_3_16b_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  dual_port_ram : entity xil_defaultlib.receive1_3_16b_xltdpram 
  generic map (
    addr_width_b => 9,
  ...
  fifo4 : entity xil_defaultlib.receive1_3_16b_xlfifogen_u 
  generic map (
    core_name0 => "receive1_3_16b_fifo_generator_i1",
    data_count_width => 10,
    data_width => 16,
    extra_registers => 1,
    has_ae => 0,
  ...
  reinterpret2 : entity xil_defaultlib.sysgen_reinterpret_b83bc3e312 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block receive1_3_16b/beat_dphi1/rst_det
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_rst_det_x1 is
  port (
    in_x0 : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end receive1_3_16b_rst_det_x1;
architecture structural of receive1_3_16b_rst_det_x1 is 
  signal logical_y_net : std_logic_vector( 1-1 downto 0 );
  signal ce_net : std_logic;
  signal clk_net : std_logic;
  signal delay4_q_net : std_logic_vector( 1-1 downto 0 );
...
-- Generated from Simulink block receive1_3_16b/beat_dphi1
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_beat_dphi1 is
  port (
    w_addr_x0 : in std_logic_vector( 9-1 downto 0 );
    w_data : in std_logic_vector( 16-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
...
end receive1_3_16b_beat_dphi1;
architecture structural of receive1_3_16b_beat_dphi1 is 
  signal constant6_op_net : std_logic_vector( 1-1 downto 0 );
  signal addsub_s_net : std_logic_vector( 16-1 downto 0 );
  signal clk_net : std_logic;
  signal constant3_op_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  rst_det : entity xil_defaultlib.receive1_3_16b_rst_det_x1 
  port map (
    in_x0 => delay4_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
-- Generated from Simulink block receive1_3_16b/beat_dphi2/rst_det
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_rst_det_x2 is
  port (
    in_x0 : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end receive1_3_16b_rst_det_x2;
architecture structural of receive1_3_16b_rst_det_x2 is 
  signal logical_y_net : std_logic_vector( 1-1 downto 0 );
  signal register_q_net : std_logic_vector( 1-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
...
-- Generated from Simulink block receive1_3_16b/beat_dphi2
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_beat_dphi2 is
  port (
    w_addr_x0 : in std_logic_vector( 9-1 downto 0 );
    w_data : in std_logic_vector( 16-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
...
end receive1_3_16b_beat_dphi2;
architecture structural of receive1_3_16b_beat_dphi2 is 
  signal delay4_q_net : std_logic_vector( 1-1 downto 0 );
  signal w_beat_dphi_net : std_logic_vector( 16-1 downto 0 );
  signal convert2_dout_net : std_logic_vector( 18-1 downto 0 );
  signal clk_net : std_logic;
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  rst_det : entity xil_defaultlib.receive1_3_16b_rst_det_x2 
  port map (
    in_x0 => delay4_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
-- Generated from Simulink block receive1_3_16b/beat_dphi3/rst_det
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_rst_det_x3 is
  port (
    in_x0 : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end receive1_3_16b_rst_det_x3;
architecture structural of receive1_3_16b_rst_det_x3 is 
  signal logical_y_net : std_logic_vector( 1-1 downto 0 );
  signal clk_net : std_logic;
  signal inverter_op_net : std_logic_vector( 1-1 downto 0 );
  signal register_q_net : std_logic_vector( 1-1 downto 0 );
...
-- Generated from Simulink block receive1_3_16b/beat_dphi3
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_beat_dphi3 is
  port (
    w_addr_x0 : in std_logic_vector( 9-1 downto 0 );
    w_data : in std_logic_vector( 16-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
...
end receive1_3_16b_beat_dphi3;
architecture structural of receive1_3_16b_beat_dphi3 is 
  signal w_beat_addr_net : std_logic_vector( 9-1 downto 0 );
  signal convert2_dout_net : std_logic_vector( 18-1 downto 0 );
  signal logical_y_net : std_logic_vector( 1-1 downto 0 );
  signal constant3_op_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  rst_det : entity xil_defaultlib.receive1_3_16b_rst_det_x3 
  port map (
    in_x0 => delay4_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
-- Generated from Simulink block receive1_3_16b/binSelect/rst_det
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_rst_det_x4 is
  port (
    in_x0 : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end receive1_3_16b_rst_det_x4;
architecture structural of receive1_3_16b_rst_det_x4 is 
  signal clk_net : std_logic;
  signal ce_net : std_logic;
  signal logical_y_net : std_logic_vector( 1-1 downto 0 );
...
-- Generated from Simulink block receive1_3_16b/binSelect/slice_and_sel
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_slice_and_sel is
  port (
...
end receive1_3_16b_slice_and_sel;
architecture structural of receive1_3_16b_slice_and_sel is 
  signal delay4_q_net : std_logic_vector( 2-1 downto 0 );
  signal dual_port_ram_douta_net : std_logic_vector( 128-1 downto 0 );
  signal ce_net : std_logic;
  signal clk_net : std_logic;
  signal mux2_y_net : std_logic_vector( 32-1 downto 0 );
  signal slice_qi_1_y_net : std_logic_vector( 32-1 downto 0 );
  signal slice_qi_3_y_net : std_logic_vector( 32-1 downto 0 );
  signal slice_qi_0_y_net : std_logic_vector( 32-1 downto 0 );
  signal slice_qi_2_y_net : std_logic_vector( 32-1 downto 0 );
begin
  data_out <= mux2_y_net;
  delay4_q_net <= sel;
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  mux2 : entity xil_defaultlib.sysgen_mux_c0c3d45d0c 
  port map (
    clr => '0',
    sel => delay4_q_net,
    d0 => slice_qi_0_y_net,
  ...
  slice_qi_0 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 31,
    x_width => 128,
  ...
  slice_qi_1 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 32,
    new_msb => 63,
    x_width => 128,
  ...
  slice_qi_2 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 64,
    new_msb => 95,
    x_width => 128,
  ...
  slice_qi_3 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 96,
    new_msb => 127,
    x_width => 128,
...
-- Generated from Simulink block receive1_3_16b/binSelect/slice_and_sel1
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_slice_and_sel1 is
  port (
    sel : in std_logic_vector( 2-1 downto 0 );
    data_in : in std_logic_vector( 128-1 downto 0 );
    clk_1 : in std_logic;
...
end receive1_3_16b_slice_and_sel1;
architecture structural of receive1_3_16b_slice_and_sel1 is 
  ...
  signal slice_qi_3_y_net : std_logic_vector( 32-1 downto 0 );
  signal slice_qi_1_y_net : std_logic_vector( 32-1 downto 0 );
  signal dual_port_ram_doutb_net : std_logic_vector( 128-1 downto 0 );
  signal ce_net : std_logic;
  signal slice_qi_2_y_net : std_logic_vector( 32-1 downto 0 );
begin
  data_out <= mux2_y_net;
...
-- Generated from Simulink block receive1_3_16b/binSelect/slice_and_sel2
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_slice_and_sel2 is
  port (
    sel : in std_logic_vector( 2-1 downto 0 );
    data_in : in std_logic_vector( 128-1 downto 0 );
    clk_1 : in std_logic;
...
end receive1_3_16b_slice_and_sel2;
architecture structural of receive1_3_16b_slice_and_sel2 is 
  signal mux2_y_net : std_logic_vector( 32-1 downto 0 );
  signal clk_net : std_logic;
  signal dual_port_ram1_douta_net : std_logic_vector( 128-1 downto 0 );
  signal ce_net : std_logic;
...
-- Generated from Simulink block receive1_3_16b/binSelect/slice_and_sel3
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_slice_and_sel3 is
  port (
    sel : in std_logic_vector( 2-1 downto 0 );
    data_in : in std_logic_vector( 128-1 downto 0 );
    clk_1 : in std_logic;
...
end receive1_3_16b_slice_and_sel3;
architecture structural of receive1_3_16b_slice_and_sel3 is 
  signal dual_port_ram1_doutb_net : std_logic_vector( 128-1 downto 0 );
...
-- Generated from Simulink block receive1_3_16b/binSelect/slice_and_sel4
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_slice_and_sel4 is
  port (
    sel : in std_logic_vector( 2-1 downto 0 );
    data_in : in std_logic_vector( 128-1 downto 0 );
    clk_1 : in std_logic;
...
end receive1_3_16b_slice_and_sel4;
architecture structural of receive1_3_16b_slice_and_sel4 is 
  signal delay4_q_net : std_logic_vector( 2-1 downto 0 );
  signal mux2_y_net : std_logic_vector( 32-1 downto 0 );
  signal dual_port_ram2_douta_net : std_logic_vector( 128-1 downto 0 );
  signal clk_net : std_logic;
  signal ce_net : std_logic;
  signal slice_qi_3_y_net : std_logic_vector( 32-1 downto 0 );
  signal slice_qi_1_y_net : std_logic_vector( 32-1 downto 0 );
...
-- Generated from Simulink block receive1_3_16b/binSelect/slice_and_sel5
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_slice_and_sel5 is
  port (
    sel : in std_logic_vector( 2-1 downto 0 );
    data_in : in std_logic_vector( 128-1 downto 0 );
    clk_1 : in std_logic;
...
end receive1_3_16b_slice_and_sel5;
architecture structural of receive1_3_16b_slice_and_sel5 is 
  signal delay5_q_net : std_logic_vector( 2-1 downto 0 );
  signal slice_qi_0_y_net : std_logic_vector( 32-1 downto 0 );
  signal dual_port_ram2_doutb_net : std_logic_vector( 128-1 downto 0 );
  signal mux2_y_net : std_logic_vector( 32-1 downto 0 );
  signal ce_net : std_logic;
  signal slice_qi_2_y_net : std_logic_vector( 32-1 downto 0 );
  signal slice_qi_1_y_net : std_logic_vector( 32-1 downto 0 );
...
-- Generated from Simulink block receive1_3_16b/binSelect/slice_and_sel6
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_slice_and_sel6 is
  port (
    sel : in std_logic_vector( 2-1 downto 0 );
    data_in : in std_logic_vector( 128-1 downto 0 );
    clk_1 : in std_logic;
...
end receive1_3_16b_slice_and_sel6;
architecture structural of receive1_3_16b_slice_and_sel6 is 
  signal clk_net : std_logic;
  signal delay6_q_net : std_logic_vector( 2-1 downto 0 );
  signal dual_port_ram3_douta_net : std_logic_vector( 128-1 downto 0 );
  signal mux2_y_net : std_logic_vector( 32-1 downto 0 );
  signal ce_net : std_logic;
  signal slice_qi_3_y_net : std_logic_vector( 32-1 downto 0 );
  signal slice_qi_1_y_net : std_logic_vector( 32-1 downto 0 );
...
-- Generated from Simulink block receive1_3_16b/binSelect/slice_and_sel7
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_slice_and_sel7 is
  port (
    sel : in std_logic_vector( 2-1 downto 0 );
    data_in : in std_logic_vector( 128-1 downto 0 );
    clk_1 : in std_logic;
...
end receive1_3_16b_slice_and_sel7;
architecture structural of receive1_3_16b_slice_and_sel7 is 
  signal slice_qi_2_y_net : std_logic_vector( 32-1 downto 0 );
  signal slice_qi_0_y_net : std_logic_vector( 32-1 downto 0 );
  signal mux2_y_net : std_logic_vector( 32-1 downto 0 );
  signal slice_qi_3_y_net : std_logic_vector( 32-1 downto 0 );
  ...
  signal ce_net : std_logic;
  signal clk_net : std_logic;
  signal dual_port_ram3_doutb_net : std_logic_vector( 128-1 downto 0 );
begin
  data_out <= mux2_y_net;
  delay7_q_net <= sel;
...
-- Generated from Simulink block receive1_3_16b/binSelect
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_binselect is
  port (
    data_in : in std_logic_vector( 128-1 downto 0 );
    tvalid_in : in std_logic_vector( 1-1 downto 0 );
...
end receive1_3_16b_binselect;
architecture structural of receive1_3_16b_binselect is 
  signal delay6_q_net : std_logic_vector( 22-1 downto 0 );
  signal delay20_q_net : std_logic_vector( 1-1 downto 0 );
  signal mux2_y_net_x7 : std_logic_vector( 128-1 downto 0 );
  ...
  signal dual_port_ram2_doutb_net : std_logic_vector( 128-1 downto 0 );
  signal mux2_y_net_x5 : std_logic_vector( 32-1 downto 0 );
  signal mux2_y_net_x0 : std_logic_vector( 32-1 downto 0 );
  signal mux2_y_net : std_logic_vector( 32-1 downto 0 );
  signal dual_port_ram_doutb_net : std_logic_vector( 128-1 downto 0 );
  signal mux2_y_net_x3 : std_logic_vector( 32-1 downto 0 );
  signal dual_port_ram_douta_net : std_logic_vector( 128-1 downto 0 );
  signal mux2_y_net_x6 : std_logic_vector( 32-1 downto 0 );
  signal mux2_y_net_x1 : std_logic_vector( 32-1 downto 0 );
  signal mux2_y_net_x4 : std_logic_vector( 32-1 downto 0 );
  signal relational1_op_net : std_logic_vector( 1-1 downto 0 );
  ...
  signal clk_net : std_logic;
  signal mux2_y_net_x2 : std_logic_vector( 32-1 downto 0 );
  signal dual_port_ram3_douta_net : std_logic_vector( 128-1 downto 0 );
  signal dual_port_ram2_douta_net : std_logic_vector( 128-1 downto 0 );
  ...
  signal constant16_op_net : std_logic_vector( 128-1 downto 0 );
  signal constant6_op_net : std_logic_vector( 128-1 downto 0 );
  signal constant4_op_net : std_logic_vector( 128-1 downto 0 );
  signal convert1_dout_net : std_logic_vector( 1-1 downto 0 );
  signal constant7_op_net : std_logic_vector( 128-1 downto 0 );
  signal constant9_op_net : std_logic_vector( 1-1 downto 0 );
  ...
  signal delay22_q_net : std_logic_vector( 128-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  rst_det : entity xil_defaultlib.receive1_3_16b_rst_det_x4 
  port map (
    in_x0 => delay5_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  slice_and_sel : entity xil_defaultlib.receive1_3_16b_slice_and_sel 
  port map (
    sel => delay4_q_net,
  ...
  slice_and_sel1 : entity xil_defaultlib.receive1_3_16b_slice_and_sel1 
  port map (
    sel => delay5_q_net_x0,
  ...
  slice_and_sel2 : entity xil_defaultlib.receive1_3_16b_slice_and_sel2 
  port map (
    sel => delay6_q_net_x0,
  ...
  slice_and_sel3 : entity xil_defaultlib.receive1_3_16b_slice_and_sel3 
  port map (
    sel => delay7_q_net,
  ...
  slice_and_sel4 : entity xil_defaultlib.receive1_3_16b_slice_and_sel4 
  port map (
    sel => delay4_q_net,
  ...
  slice_and_sel5 : entity xil_defaultlib.receive1_3_16b_slice_and_sel5 
  port map (
    sel => delay5_q_net_x0,
  ...
  slice_and_sel6 : entity xil_defaultlib.receive1_3_16b_slice_and_sel6 
  port map (
    sel => delay6_q_net_x0,
  ...
  slice_and_sel7 : entity xil_defaultlib.receive1_3_16b_slice_and_sel7 
  port map (
    sel => delay7_q_net,
  ...
  accumulator1 : entity xil_defaultlib.sysgen_accum_2fc88a7dd1 
  port map (
    clr => '0',
  ...
  addsub1 : entity xil_defaultlib.sysgen_addsub_40598f35ec 
  port map (
    clr => '0',
    a => mux3_y_net,
    b => constant5_op_net,
  ...
  concat : entity xil_defaultlib.sysgen_concat_5c52ce5aa5 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant10 : entity xil_defaultlib.sysgen_constant_47b1ca8820 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant11 : entity xil_defaultlib.sysgen_constant_47b1ca8820 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant16 : entity xil_defaultlib.sysgen_constant_5648920754 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant3 : entity xil_defaultlib.sysgen_constant_eb28ad17ba 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant4 : entity xil_defaultlib.sysgen_constant_5648920754 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant5 : entity xil_defaultlib.sysgen_constant_196a632e43 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant6 : entity xil_defaultlib.sysgen_constant_5648920754 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant7 : entity xil_defaultlib.sysgen_constant_5648920754 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant8 : entity xil_defaultlib.sysgen_constant_47b1ca8820 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant9 : entity xil_defaultlib.sysgen_constant_47b1ca8820 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  convert1 : entity xil_defaultlib.receive1_3_16b_xlconvert 
  generic map (
    bool_conversion => 1,
    din_arith => 1,
    din_bin_pt => 0,
  ...
  counter2 : entity xil_defaultlib.receive1_3_16b_xlcounter_free 
  generic map (
    core_name0 => "receive1_3_16b_c_counter_binary_v12_0_i3",
    op_arith => xlUnsigned,
    op_width => 10
  )
  port map (
  ...
  delay20 : entity xil_defaultlib.receive1_3_16b_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  delay22 : entity xil_defaultlib.receive1_3_16b_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  delay6 : entity xil_defaultlib.receive1_3_16b_xldelay 
  generic map (
    latency => 2,
    reg_retiming => 0,
    reset => 0,
  ...
  delay7 : entity xil_defaultlib.receive1_3_16b_xldelay 
  generic map (
    latency => 2,
    reg_retiming => 0,
    reset => 0,
  ...
  delay8 : entity xil_defaultlib.receive1_3_16b_xldelay 
  generic map (
    latency => 2,
    reg_retiming => 0,
    reset => 0,
  ...
  dual_port_ram1 : entity xil_defaultlib.receive1_3_16b_xltdpram 
  generic map (
    addr_width_b => 9,
    clocking_mode => "common_clock",
    data_width_b => 128,
  ...
  dual_port_ram2 : entity xil_defaultlib.receive1_3_16b_xltdpram 
  generic map (
    addr_width_b => 9,
    clocking_mode => "common_clock",
    data_width_b => 128,
  ...
  dual_port_ram3 : entity xil_defaultlib.receive1_3_16b_xltdpram 
  generic map (
    addr_width_b => 9,
    clocking_mode => "common_clock",
    data_width_b => 128,
  ...
  inverter2 : entity xil_defaultlib.sysgen_inverter_fa5d2f3a2b 
  port map (
    clr => '0',
  ...
  mux2 : entity xil_defaultlib.sysgen_mux_f69c9ab50f 
  port map (
    clr => '0',
    sel => delay8_q_net,
    d0 => concat_y_net,
  ...
  mux3 : entity xil_defaultlib.sysgen_mux_ae181aee2c 
  port map (
    clr => '0',
    sel => delay20_q_net,
    d0 => counter2_op_net,
  ...
  mux5 : entity xil_defaultlib.sysgen_mux_1e5c93af90 
  port map (
    clr => '0',
  ...
  mux6 : entity xil_defaultlib.sysgen_mux_1e5c93af90 
  port map (
    clr => '0',
    sel => convert1_dout_net,
  ...
  mux7 : entity xil_defaultlib.sysgen_mux_1e5c93af90 
  port map (
    clr => '0',
    sel => convert1_dout_net,
    d0 => delay19_q_net_x0,
  ...
  mux8 : entity xil_defaultlib.sysgen_mux_1e5c93af90 
  port map (
    clr => '0',
    sel => convert1_dout_net,
    d0 => delay19_q_net_x0,
  ...
  relational1 : entity xil_defaultlib.sysgen_relational_9689368a54 
  port map (
    clr => '0',
    a => counter3_op_net,
    b => constant3_op_net,
  ...
  addr0_slice : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 10,
    x_width => 22,
  ...
  addr1_slice : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 11,
    new_msb => 21,
    x_width => 22,
  ...
  addr2_slice : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 10,
    x_width => 22,
  ...
  addr3_slice : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 11,
    new_msb => 21,
    x_width => 22,
  ...
  binselectram : entity xil_defaultlib.receive1_3_16b_xltdpram 
  generic map (
    addr_width_b => 10,
    clocking_mode => "common_clock",
    data_width_b => 22,
  ...
  low2_slice : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 1,
    x_width => 11,
  ...
  low2_slice1 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 1,
    x_width => 11,
  ...
  low2_slice2 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 1,
    x_width => 11,
  ...
  low2_slice3 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 1,
    x_width => 11,
  ...
  top9_slice : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 2,
    new_msb => 10,
    x_width => 11,
  ...
  top9_slice1 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 2,
    new_msb => 10,
    x_width => 11,
  ...
  top9_slice2 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 2,
    new_msb => 10,
    x_width => 11,
  ...
  top9_slice3 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 2,
    new_msb => 10,
    x_width => 11,
...
-- Generated from Simulink block receive1_3_16b/in_im
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_in_im is
  port (
...
end receive1_3_16b_in_im;
architecture structural of receive1_3_16b_in_im is 
  signal in_im_2_net : std_logic_vector( 16-1 downto 0 );
  signal in_im_1_net : std_logic_vector( 16-1 downto 0 );
  signal in_im_3_net : std_logic_vector( 16-1 downto 0 );
  signal in_im_0_net : std_logic_vector( 16-1 downto 0 );
...
-- Generated from Simulink block receive1_3_16b/in_re
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_in_re is
  port (
...
end receive1_3_16b_in_re;
architecture structural of receive1_3_16b_in_re is 
  signal in_re_1_net : std_logic_vector( 16-1 downto 0 );
  signal in_re_0_net : std_logic_vector( 16-1 downto 0 );
  signal in_re_2_net : std_logic_vector( 16-1 downto 0 );
  signal in_re_3_net : std_logic_vector( 16-1 downto 0 );
...
-- Generated from Simulink block receive1_3_16b/rst_det
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_rst_det is
  port (
    in_x0 : in std_logic;
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end receive1_3_16b_rst_det;
architecture structural of receive1_3_16b_rst_det is 
  signal logical1_y_net : std_logic_vector( 1-1 downto 0 );
  signal ce_net : std_logic;
  signal clk_net : std_logic;
  signal logical_y_net : std_logic_vector( 1-1 downto 0 );
...
-- Generated from Simulink block receive1_3_16b_struct
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_struct is
  port (
    ...
    fft_op_scale : out std_logic_vector( 11-1 downto 0 );
...
end receive1_3_16b_struct;
architecture structural of receive1_3_16b_struct is 
  ...
  signal delay2_q_net_x7 : std_logic_vector( 32-1 downto 0 );
  signal beat_we2_net : std_logic_vector( 1-1 downto 0 );
  signal delay2_q_net_x4 : std_logic_vector( 32-1 downto 0 );
  signal delay2_q_net_x5 : std_logic_vector( 32-1 downto 0 );
  signal w_beat_dphi_net : std_logic_vector( 16-1 downto 0 );
  ...
  signal mux1_y_net : std_logic_vector( 16-1 downto 0 );
  signal delay5_q_net : std_logic_vector( 1-1 downto 0 );
  signal delay2_q_net_x8 : std_logic_vector( 11-1 downto 0 );
  signal reinterpret14_output_port_net : std_logic_vector( 16-1 downto 0 );
  signal slice3_y_net_x0 : std_logic_vector( 13-1 downto 0 );
  signal delay19_q_net : std_logic_vector( 22-1 downto 0 );
  signal slice0_y_net : std_logic_vector( 13-1 downto 0 );
  ...
  signal mux2_y_net_x1 : std_logic_vector( 128-1 downto 0 );
  ...
  signal slice_i1_y_net : std_logic_vector( 16-1 downto 0 );
  signal slice_i0_y_net : std_logic_vector( 16-1 downto 0 );
  signal slice_q1_y_net : std_logic_vector( 16-1 downto 0 );
  signal slice_q0_y_net : std_logic_vector( 16-1 downto 0 );
  signal slice_i2_y_net : std_logic_vector( 16-1 downto 0 );
  signal slice_q2_y_net : std_logic_vector( 16-1 downto 0 );
  signal slice_i3_y_net : std_logic_vector( 16-1 downto 0 );
  signal slice_q3_y_net : std_logic_vector( 16-1 downto 0 );
begin
  snap_q1 <= delay2_q_net_x4;
  snap_q2 <= delay2_q_net_x5;
  ...
  fft_op_scale <= test_systolicfft_vhdl_black_box_so_net;
  ...
  snap_i0 <= delay2_q_net_x7;
  snap_i1 <= delay2_q_net_x9;
  snap_i2 <= delay2_q_net_x3;
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  x0001 : entity xil_defaultlib.receive1_3_16b_0001 
  port map (
  ...
  subsystem : entity xil_defaultlib.receive1_3_16b_subsystem 
  port map (
    rst => logical_y_net,
    tvalid_in => cordic_6_0_0_m_axis_dout_tvalid_net,
    acc_length => delay16_q_net,
    ...
    ce_1 => ce_net,
    tvalid_out => logical1_y_net,
    i0_out => delay2_q_net_x7,
    q0_out => delay2_q_net_x6,
    i1_out => delay2_q_net_x9,
    q1_out => delay2_q_net_x4,
    i2_out => delay2_q_net_x3,
    q2_out => delay2_q_net_x5,
    i3_out => delay2_q_net_x2,
    q3_out => delay2_q_net_x1,
    tvalid_snap => delay1_q_net_x1,
    tvalid_out_eth => delay4_q_net
  );
  vector_concat : entity xil_defaultlib.receive1_3_16b_vector_concat 
  port map (
  ...
  vector_constant : entity xil_defaultlib.receive1_3_16b_vector_constant 
  port map (
    out1_1 => constant0_op_net,
    out1_2 => constant1_op_net,
    out1_3 => constant2_op_net,
  ...
  vector_delay : entity xil_defaultlib.receive1_3_16b_vector_delay 
  port map (
    d_1 => in_re_0_net,
    d_2 => in_re_1_net,
    d_3 => in_re_2_net,
  ...
  vector_delay1 : entity xil_defaultlib.receive1_3_16b_vector_delay1 
  port map (
    d_1 => in_im_0_net,
    d_2 => in_im_1_net,
    d_3 => in_im_2_net,
  ...
  vector_fft : entity xil_defaultlib.receive1_3_16b_vector_fft 
  port map (
    i_re_1 => slice0_y_net_x0,
    i_im_1 => slice0_y_net,
    vi => delay1_q_net_x2,
    si => delay2_q_net_x8,
    i_re_2 => slice1_y_net_x0,
    i_re_3 => slice2_y_net_x0,
    i_re_4 => slice3_y_net_x0,
    i_im_2 => slice1_y_net,
    i_im_3 => slice2_y_net,
    i_im_4 => slice3_y_net,
    clk_1 => clk_net,
  ...
  vector_mux : entity xil_defaultlib.receive1_3_16b_vector_mux 
  port map (
    sel => register_q_net,
  ...
  vector_mux1 : entity xil_defaultlib.receive1_3_16b_vector_mux1 
  port map (
    sel => register_q_net,
    i0_1 => constant0_op_net,
  ...
  vector_reinterpret : entity xil_defaultlib.receive1_3_16b_vector_reinterpret 
  port map (
    in_1 => mux0_y_net_x0,
    in_2 => mux1_y_net_x0,
    in_3 => mux2_y_net_x0,
  ...
  vector_reinterpret2 : entity xil_defaultlib.receive1_3_16b_vector_reinterpret2 
  port map (
    in_1 => mux0_y_net,
    in_2 => mux1_y_net,
    in_3 => mux2_y_net,
  ...
  vector_slice : entity xil_defaultlib.receive1_3_16b_vector_slice 
  port map (
    in_1 => delay0_q_net_x0,
    in_2 => delay1_q_net_x0,
  ...
  vector_slice1 : entity xil_defaultlib.receive1_3_16b_vector_slice1 
  port map (
    in_1 => delay0_q_net,
    in_2 => delay1_q_net,
    in_3 => delay2_q_net,
  ...
  vector_to_scalar : entity xil_defaultlib.receive1_3_16b_vector_to_scalar 
  port map (
    i_1 => concat0_y_net,
  ...
  beat_dphi0 : entity xil_defaultlib.receive1_3_16b_beat_dphi0 
  port map (
  ...
  beat_dphi1 : entity xil_defaultlib.receive1_3_16b_beat_dphi1 
  port map (
    w_addr_x0 => w_beat_addr_net,
    w_data => w_beat_dphi_net,
    we => beat_we1_net,
  ...
  beat_dphi2 : entity xil_defaultlib.receive1_3_16b_beat_dphi2 
  port map (
    w_addr_x0 => w_beat_addr_net,
    w_data => w_beat_dphi_net,
    we => beat_we2_net,
  ...
  beat_dphi3 : entity xil_defaultlib.receive1_3_16b_beat_dphi3 
  port map (
    w_addr_x0 => w_beat_addr_net,
    w_data => w_beat_dphi_net,
    we => beat_we3_net,
  ...
  binselect : entity xil_defaultlib.receive1_3_16b_binselect 
  port map (
  ...
  in_im : entity xil_defaultlib.receive1_3_16b_in_im 
  port map (
    in_im_0 => in_im_0_net,
    in_im_1 => in_im_1_net,
    in_im_2 => in_im_2_net,
  ...
  in_re : entity xil_defaultlib.receive1_3_16b_in_re 
  port map (
    in_re_0 => in_re_0_net,
    in_re_1 => in_re_1_net,
    in_re_2 => in_re_2_net,
  ...
  rst_det : entity xil_defaultlib.receive1_3_16b_rst_det 
  port map (
  ...
  cordic_6_0_0 : entity xil_defaultlib.xlcordic_6ad1f574da29ca67c95e8c33f7f118d9 
  port map (
  ...
  cordic_6_0_1 : entity xil_defaultlib.xlcordic_6ad1f574da29ca67c95e8c33f7f118d9 
  port map (
    s_axis_cartesian_tvalid => tvalid,
  ...
  cordic_6_0_2 : entity xil_defaultlib.xlcordic_6ad1f574da29ca67c95e8c33f7f118d9 
  port map (
    s_axis_cartesian_tvalid => tvalid,
  ...
  cordic_6_0_3 : entity xil_defaultlib.xlcordic_6ad1f574da29ca67c95e8c33f7f118d9 
  port map (
    s_axis_cartesian_tvalid => tvalid,
  ...
  constant1 : entity xil_defaultlib.sysgen_constant_47b1ca8820 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  convert3 : entity xil_defaultlib.receive1_3_16b_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 2,
    din_bin_pt => 15,
  ...
  convert4 : entity xil_defaultlib.receive1_3_16b_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 2,
    din_bin_pt => 15,
  ...
  convert5 : entity xil_defaultlib.receive1_3_16b_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 2,
    din_bin_pt => 15,
  ...
  convert6 : entity xil_defaultlib.receive1_3_16b_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 2,
    din_bin_pt => 15,
  ...
  convert7 : entity xil_defaultlib.receive1_3_16b_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 2,
    din_bin_pt => 15,
  ...
  convert8 : entity xil_defaultlib.receive1_3_16b_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 2,
    din_bin_pt => 15,
  ...
  reinterpret : entity xil_defaultlib.sysgen_reinterpret_b83bc3e312 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret1 : entity xil_defaultlib.sysgen_reinterpret_b83bc3e312 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret3 : entity xil_defaultlib.sysgen_reinterpret_b83bc3e312 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret4 : entity xil_defaultlib.sysgen_reinterpret_b83bc3e312 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret5 : entity xil_defaultlib.sysgen_reinterpret_b83bc3e312 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret6 : entity xil_defaultlib.sysgen_reinterpret_b83bc3e312 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret7 : entity xil_defaultlib.sysgen_reinterpret_b83bc3e312 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  slice_i0 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 16,
    new_msb => 31,
    x_width => 128,
  ...
  slice_i1 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 48,
    new_msb => 63,
    x_width => 128,
  ...
  slice_i2 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 80,
    new_msb => 95,
    x_width => 128,
  ...
  slice_i3 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 112,
    new_msb => 127,
    x_width => 128,
  ...
  slice_q0 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 15,
    x_width => 128,
  ...
  slice_q1 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 32,
    new_msb => 47,
    x_width => 128,
  ...
  slice_q2 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 64,
    new_msb => 79,
    x_width => 128,
  ...
  slice_q3 : entity xil_defaultlib.receive1_3_16b_xlslice 
  generic map (
    new_lsb => 96,
    new_msb => 111,
    x_width => 128,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity receive1_3_16b_default_clock_driver is
  port (
    receive1_3_16b_sysclk : in std_logic;
    receive1_3_16b_sysce : in std_logic;
    receive1_3_16b_sysclr : in std_logic;
    receive1_3_16b_clk1 : out std_logic;
    receive1_3_16b_ce1 : out std_logic
  );
end receive1_3_16b_default_clock_driver;
architecture structural of receive1_3_16b_default_clock_driver is 
begin
  ...
  port map (
    sysclk => receive1_3_16b_sysclk,
    sysce => receive1_3_16b_sysce,
    sysclr => receive1_3_16b_sysclr,
    clk => receive1_3_16b_clk1,
    ce => receive1_3_16b_ce1
  );
end structural;
-- Generated from Simulink block 
library IEEE;
...
entity receive1_3_16b is
  port (
    ...
    w_binsel_data1 : in std_logic_vector( 22-1 downto 0 );
    acc_length : in std_logic_vector( 23-1 downto 0 );
    beat_we0 : in std_logic;
    beat_we1 : in std_logic;
    beat_we2 : in std_logic;
    beat_we3 : in std_logic;
    binsel_we : in std_logic;
    fft_scale : in std_logic_vector( 11-1 downto 0 );
    ...
    snap_q2 : out std_logic_vector( 32-1 downto 0 );
    snap_q3 : out std_logic_vector( 32-1 downto 0 );
    snap_tvalid : out std_logic;
    fft_op_scale : out std_logic_vector( 11-1 downto 0 );
    acc_tvalid : out std_logic;
    acc_tvalid_eth : out std_logic;
    snap_i0 : out std_logic_vector( 32-1 downto 0 );
    snap_i1 : out std_logic_vector( 32-1 downto 0 );
    snap_i2 : out std_logic_vector( 32-1 downto 0 );
    snap_i3 : out std_logic_vector( 32-1 downto 0 );
...
architecture structural of receive1_3_16b is 
  attribute core_generation_info : string;
  attribute core_generation_info of structural : architecture is "receive1_3_16b,sysgen_core_2021_1,{,compilation=IP Catalog,block_icon_display=Default,family=zynquplusRFSOC,part=xczu28dr,speed=-2-e,package=ffvg1517,synthesis_language=vhdl,hdl_library=xil_defaultlib,synthesis_strategy=Vivado Synthesis Defaults,implementation_strategy=Vivado Implementation Defaults,testbench=0,interface_doc=0,ce_clr=0,clock_period=10,system_simulink_period=1,waveform_viewer=0,axilite_interface=0,ip_catalog_plugin=0,hwcosim_burst_mode=0,simulation_time=20000,accum=1,addsub=13,blackbox2=1,concat=12,constant=90,convert=13,cordic_v6_0=4,counter=23,delay=102,dpram=9,fifo=12,inv=7,logical=28,mux=54,register=23,reinterpret=36,relational=18,slice=72,}";
  signal clk_1_net : std_logic;
  signal ce_1_net : std_logic;
begin
  receive1_3_16b_default_clock_driver : entity xil_defaultlib.receive1_3_16b_default_clock_driver 
  port map (
    receive1_3_16b_sysclk => clk,
    receive1_3_16b_sysce => '1',
    receive1_3_16b_sysclr => '0',
    receive1_3_16b_clk1 => clk_1_net,
    receive1_3_16b_ce1 => ce_1_net
  );
  receive1_3_16b_struct : entity xil_defaultlib.receive1_3_16b_struct 
  port map (
    ...
    beat_we2(0) => beat_we2,
    beat_we3(0) => beat_we3,
    binsel_we(0) => binsel_we,
    fft_scale => fft_scale,
    in_tvalid(0) => in_tvalid,
    in_im_0 => in_im_0,
    in_im_1 => in_im_1,
    in_im_2 => in_im_2,
    in_im_3 => in_im_3,
    ...
    snap_q2 => snap_q2,
    snap_q3 => snap_q3,
    snap_tvalid(0) => snap_tvalid,
    fft_op_scale => fft_op_scale,
    acc_tvalid(0) => acc_tvalid,
    acc_tvalid_eth(0) => acc_tvalid_eth,
    snap_i0 => snap_i0,
    snap_i1 => snap_i1,
    snap_i2 => snap_i2,
    snap_i3 => snap_i3,
