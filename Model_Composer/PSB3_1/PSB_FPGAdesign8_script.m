...
win_coeffs_reshaped_simulink_1 = csvread('input_files/win_coeffs_reshaped_1.csv'); % For sim only
win_coeffs_reshaped_simulink_2 = csvread('input_files/win_coeffs_reshaped_2.csv'); % For sim only
win_coeffs_reshaped_simulink_3 = csvread('input_files/win_coeffs_reshaped_3.csv'); % For sim only
win_coeffs_reshaped_simulink_4 = csvread('input_files/win_coeffs_reshaped_4.csv'); % For sim only
...
% simout = sim('PSB_FPGAdesign8_model.slx', sim_sec);
% 
% writematrix(simout.CORDIC_out_tvalid,'Simulink_output_files_2/CORDIC_out_tvalid.csv');
% writematrix(simout.CORDIC_out_re,'Simulink_output_files_2/CORDIC_out_re.csv');
% writematrix(simout.CORDIC_out_im,'Simulink_output_files_2/CORDIC_out_im.csv');
% 
% writematrix(simout.vIFFT_out_re,'Simulink_output_files_2/vIFFT_out_re.csv');
% writematrix(simout.vIFFT_out_im,'Simulink_output_files_2/vIFFT_out_im.csv');
% writematrix(simout.vIFFT_out_tvalid,'Simulink_output_files_2/vIFFT_out_tvalid.csv');
% writematrix(simout.vIFFT_out_scale,'Simulink_output_files_2/vIFFT_out_scale.csv');
% 
% writematrix(simout.PSB_out_tvalid,'Simulink_output_files_2/PSB_out_tvalid.csv');
% writematrix(simout.PSB_out_re,'Simulink_output_files_2/PSB_out_re.csv');
% writematrix(simout.PSB_out_im,'Simulink_output_files_2/PSB_out_im.csv');
