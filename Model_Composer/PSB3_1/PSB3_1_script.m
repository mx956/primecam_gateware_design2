% PSB3_1 differs from PSB3_0 only in the addition of ifft_scale port
% and top level port naming changes.
clear; clc; close all;
...
toneMap_0 = csvread('ToneSelect_map_default/toneMap_default_0.csv');
toneMap_1 = csvread('ToneSelect_map_default/toneMap_default_1.csv');
toneMap_2 = csvread('ToneSelect_map_default/toneMap_default_2.csv');
toneMap_3 = csvread('ToneSelect_map_default/toneMap_default_3.csv');
toneMap_4 = csvread('ToneSelect_map_default/toneMap_default_4.csv');
toneMap_5 = csvread('ToneSelect_map_default/toneMap_default_5.csv');
toneMap_6 = csvread('ToneSelect_map_default/toneMap_default_6.csv');
toneMap_7 = csvread('ToneSelect_map_default/toneMap_default_7.csv');
